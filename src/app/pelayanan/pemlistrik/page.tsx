...
export default function Pemlistrik () {
  return (
    <div className="lg:w-full mx-auto lg:py-10 dark:bg-blue-500">
      ...
      <Image src="/assets/pemasangan.svg"alt="Pemasangan Listrik" width={200}height={200} className="transition-all duration-300 ease-in-out hover:scale-105 lg:w-1/4 mx-auto sm:w-1/6 md:w-1/3" loading='lazy'/>
