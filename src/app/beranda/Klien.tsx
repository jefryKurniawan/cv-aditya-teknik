...
export default function Page() {
  const data = [
    'Bank Rakyat Indonesia','Seluruh Rayon PLN Malang Raya','Midfile New Height of Living','Malang Villa Estate','Sekolah Dasar Negeri Blimbing 3','Sekolah Dasar Negeri Mojolangu','Malang Bhayangkara Redsidence','Harmonika', 'Green Elok Redsidence Singosari', 'Asrikaton Pakis Redsidence','Bunga Citra Lestari Redsidence','Bank Rakyat Indonesia','Seluruh Rayon PLN Malang Raya','Midfile New Height of Living','Malang Villa Estate','Sekolah Dasar Negeri Blimbing 3','Sekolah Dasar Negeri Mojolangu','Malang Bhayangkara Redsidence','Harmonika', 'Green Elok Redsidence Singosari', 'Asrikaton Pakis Redsidence','Bunga Citra Lestari Redsidence','Bank Rakyat Indonesia','Seluruh Rayon PLN Malang Raya','Midfile New Height of Living','Malang Villa Estate','Sekolah Dasar Negeri Blimbing 3','Sekolah Dasar Negeri Mojolangu','Malang Bhayangkara Redsidence','Harmonika', 'Green Elok Redsidence Singosari', 'Asrikaton Pakis Redsidence','Bunga Citra Lestari Redsidence',
  ];
