...
export default function Page() {
  const data = [
    'Bank Rakyat Indonesia','Seluruh Rayon PLN Malang Raya','Midvile New Height of Living','Malang Villa Estate','Sekolah Dasar Negeri Blimbing 3','Sekolah Dasar Negeri Mojolangu','Malang Bhayangkara Residence','Harmonika', 'Green Elok Residence Singosari', 'Asrikaton Pakis Residence','Bunga Citra Lestari Residence','Bank Rakyat Indonesia','Seluruh Rayon PLN Malang Raya','Midvile New Height of Living','Malang Villa Estate','Sekolah Dasar Negeri Blimbing 3','Sekolah Dasar Negeri Mojolangu','Malang Bhayangkara Residence','Harmonika', 'Green Elok Residence Singosari', 'Asrikaton Pakis Residence','Bunga Citra Lestari Residence','Bank Rakyat Indonesia','Seluruh Rayon PLN Malang Raya','Midvile New Height of Living','Malang Villa Estate','Sekolah Dasar Negeri Blimbing 3','Sekolah Dasar Negeri Mojolangu','Malang Bhayangkara Residence','Harmonika', 'Green Elok Residence Singosari', 'Asrikaton Pakis Residence','Bunga Citra Lestari Residence',
  ];
